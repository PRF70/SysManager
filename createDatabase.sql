...
-- Senha tabela de banco de dados
...
`costPrice` decimal(10,9) DEFAULT 0  COMMENT 'preço de custo do produto',
`percentage` decimal(10,9) DEFAULT 0  COMMENT 'percentual de venda do produto',
`price` decimal(10,9) DEFAULT 0  COMMENT 'preço final do produto',
